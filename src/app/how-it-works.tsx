    ...
    <section className="relative py-12 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-2xl text-center mb-8">
          <h2 className="text-base font-semibold leading-7 text-primary mb-1">
            How It Works
          </h2>
                ...
                <div className={`flex items-center gap-4 ${index % 2 === 1 ? 'flex-row-reverse' : ''}`}>
                  <div className="relative flex-none">
                    ...
                    {index < steps.length - 1 && (
                      <div className="absolute top-full left-1/2 -translate-x-1/2 w-px h-6 bg-gradient-to-b from-primary/20 to-transparent" />
                    )}
                  </div>
